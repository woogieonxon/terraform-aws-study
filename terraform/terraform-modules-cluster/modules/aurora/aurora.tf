resource "aws_rds_cluster" "rds-cluster" {
  cluster_identifier              = lower("aws-rds-cluster-dev-koreait-aurora-koreait-db")
...
resource "aws_rds_cluster_instance" "rds-instance" {
  ...
  identifier                  = lower("aws-rds-instance-dev-koreait-aurora-koreaitdb-${count.index}")
...
resource "aws_rds_cluster_parameter_group" "rds-cluster-parameter-group" {
  name=lower("aws-rds-cluster-parameter-group-dev-koreait-aurora-koreait-db")
...
resource "aws_db_parameter_group" "rds-instance-parameter-group" {
  name        = lower("aws-rds-instance-parameter-group-dev-koreait-aurora-koreait-db")
